        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form id="registerFormValidation" action="validation.html" method="" novalidate="">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <form id="loginFormValidation" action="validation.html" method="" novalidate="">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <form id="allInputsFormValidation" class="form-horizontal" action="validation.html" method="post" novalidate="">
                            <div class="content">
                                ...
                                <legend>Range validation</legend>

                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Min Length</label>
                                        <div class="col-sm-6">
                                            <input class="form-control"
                                                   type="text"
                                                   name="min_length"
